...
# eUnits -> the CurrUnits string SAP writes in PROGRAM CONTROL (2026-09-15)
_UNITS = {1: "Lb, in, F", 2: "Lb, ft, F", 3: "Kip, in, F", 4: "Kip, ft, F",
...
class SapSession:
    ...
    @property
    def units(self) -> str:
        """Present units as SAP's CurrUnits string, e.g. "Kip, ft, F"."""
        return _UNITS.get(int(self.model.GetPresentUnits()), "Kip, ft, F")
    ...
    def results_s2k(self) -> str:
        ...
        lines = ['File generated by tankbuilder.sap_api (SAP2000 OAPI results)', "",
                 ...
                 f'   ProgramName=SAP2000   Version={self.version}   CurrUnits="{self.units}"', ""]
