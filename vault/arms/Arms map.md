...
- STAAD — the post-processing lib itself (`scripts/lib/`): `.anl` readers, DSRs, section cuts, STAAD input generation. No arm note yet; see the audit in the sanitized-lib audit (Notes vault) for the re-hydration state.
