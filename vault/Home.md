...
- `pythonTools/sap/` — development-side Python: `build_tank.py` + `configs/*.toml` generate the
  SAP2000 tank `.s2k` (`python build_tank.py configs/tank_hoop.toml` → `models/<name>/`);
